...
export const sheets: SheetProgress[] = [
  {
    ...
    topics: [
      ...
      { name: "Binary Search", solved: 29, total: 32 },
      { name: "Strings", solved: 13, total: 15 },
      { name: "Linked List", solved: 28, total: 31 },
      { name: "Recursion", solved: 10, total: 25 },
      { name: "Bit Manipulation", solved: 15, total: 18 },
      { name: "Stacks & Queues", solved: 28, total: 30 },
      { name: "Sliding Window", solved: 9, total: 12 },
  ...
  },
  {
    ...
    topics: [
      ...
      { name: "1300", solved: 20, total: 31 },
      { name: "1400", solved: 21, total: 31 },
      { name: "1500", solved: 3, total: 31 },
